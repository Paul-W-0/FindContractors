...
from .models import Profile, Job, SecurityReport, JobApplication
...
class JobCreationForm(forms.ModelForm):
    ...
    class Meta:
        model = Job
        fields = ('title', 'description', 'job_type', 'work_duties', 'preferred_certifications', 'minimum_qualifications', 'slug')
